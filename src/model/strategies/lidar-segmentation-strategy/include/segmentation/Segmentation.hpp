...
namespace model {
	...
	private:
        ...
        static uint64_t calculate_segment_of_point_cloud(SensorData &in, int object_no_in, const std::vector<Vector3d> &bounding_box_corners, const TransformationFunctions::EgoData &ego_data, const Profile &profile, const Log &log);
