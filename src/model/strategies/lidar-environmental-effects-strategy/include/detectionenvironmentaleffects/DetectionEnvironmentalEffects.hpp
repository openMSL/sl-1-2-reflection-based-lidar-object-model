...
namespace model {
    ...
    private:
        ...
        void add_attenuated_existing_detection(std::vector<double> &detection_intensities, std::vector<double> &detection_distances, std::vector<int> existing_detection_idx,
                                               int emitted_signal_idx, const osi3::LidarDetection &existing_detection, double attenuation, double attenuation_distance);
        void add_max_detection(std::vector<double> &detection_intensities, std::vector<double> &detection_distances,osi3::LidarDetectionData *current_sensor, const osi3::SpatialSignalStrength& current_beam);
